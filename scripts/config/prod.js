...
export const config = {
  ...
  martech: {
    ...
    martech: {
      ...
      launchUrls: ['/scripts/martech/libraries/launch-6b226db2f358.min.js'],
  ...
  widgets: {
    ...
    login: {
      oauthInitBundleUri:
        'https://cdn.qantasloyalty.com/appcache/qfa-qff-oauth-login/master/0.0.0/oauth.js',
      oauthBundleUri:
        'https://cdn.qantasloyalty.com/appcache/qdd-oauth-login/master/0.0.0/bundle.js',
      oauthLoginRibbonBundleUri:
        'https://cdn.qantasloyalty.com/appcache/qdd-login-ribbon/master/25.717.1561/bundle.js',
    },
    shopping_cart: {
      scriptPath:
        'https://static.qantas.com/ams02/a974/62/prod/eds-master/shoppingcart_widget/current/app.js',
    },
  },
};
