...
export const config = {
  ...
  dam: {
    useAkamai: true, // This is a toggle to switch between Adobe and Akamai for testing.
    url: '/dynamic-assets/',
    domain: 'https://main.dev.qantas.com', // use relative path if empty
  },
  ...
  martech: {
    ...
    martech: {
      ...
      launchUrls: [
        'https://assets.adobedtm.com/a086326e8d0e/67ff493e223e/launch-3a0ff2a3df77-development.min.js',
      ],
  ...
  widgets: {
    ...
    login: {
      oauthInitBundleUri:
        'https://cdn.sit.qantasloyalty.com/appcache/qfa-qff-oauth-login/master/0.0.0/oauth.js',
      oauthBundleUri:
        'https://cdn.sit.qantasloyalty.com/appcache/qdd-oauth-login/master/0.0.0/bundle.js',
      oauthLoginRibbonBundleUri:
        'https://cdn.sit.qantasloyalty.com/appcache/qdd-login-ribbon/master/25.717.1561/bundle.js',
    },
    shopping_cart: {
      scriptPath:
