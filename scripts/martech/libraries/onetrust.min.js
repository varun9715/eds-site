var OneTrustStub = ((t) => {
  ...
  var m = new (function () {
    ...
    h =
      ((g.initCSPTrustedType = function (t) {
        var n = new URL(t);
        window.DOMPurify &&
          window.trustedTypes &&
          window.trustedTypes.createPolicy &&
          (window.OtTrustedType.TrustedTypePolicy = window.trustedTypes.createPolicy(
            'ot-trusted-type-policy',
            {
      ...
      (g.isCspTrustedType = function () {
        var t;
        return (
          (null == (t = window.OtTrustedType) ? void 0 : t.isCspTrustedTypeEnabled) &&
          (null == (t = window.OtTrustedType) ? void 0 : t.TrustedTypePolicy)
        );
      }),
      (g.createScriptURL = function (t) {
        return g.isCspTrustedType()
  ...
  (f.prototype.initConsentSDK = function () {
    ...
    (f.prototype.captureNonce = function () {
      this.nonce =
        l.stubScriptElement.nonce || l.stubScriptElement.getAttribute('nonce') || null;
    }),
      ...
      e &&
        ...
        ((e = window.sessionStorage) && e.getItem('bulkDomainMgmtEnabled')
          ? this.handleBulkDomainMgmt(
              {
                isValid:
                  'true' === window.sessionStorage.getItem('bulkDomainMgmtEnabled'),
              },
              t,
            )
          : ((n = {
    ...
    (f.prototype.getLocation = function (t) {
      if (
        ...
        h.checkAndAssignCspTrustedTypeEnabled(t) &&
          h.initCSPTrustedType(l.storageBaseURL),
        !t.RuleSet[0].Type)
      )
        return (
          (this.iabTypeAdded = !1),
      ...
      i.OneTrust && i.OneTrust.geolocationResponse
        ? ((i = i.OneTrust.geolocationResponse),
          ...
          this.addBannerSDKScript(t))
        : (i = this.readCookieParam(l.optanonCookieName, l.geolocationCookiesParam)) ||
            t.SkipGeolocation
          ? ((e = i.split(';')[0]),
            (i = i.split(';')[1]),
    ...
    (f.prototype.getGeolocationURL = function (t) {
      t.TenantFeatures;
      var e =
        '' + l.stubScriptElement.getAttribute('src').split(l.stubFileName)[0] + t.Version;
    ...
    (f.prototype.validateIABGDPRApplied = function () {
      var t = this.readCookieParam(l.optanonCookieName, l.geolocationCookiesParam).split(
        ';',
      )[0];
      t
        ? this.isBoolean(t)
    ...
    (f.prototype.setStubScriptElement = function () {
      ...
      l.stubScriptElement && l.stubScriptElement.hasAttribute(l.DATAFILEATTRIBUTE)
        ? (this.domainId = l.stubScriptElement.getAttribute(l.DATAFILEATTRIBUTE).trim())
        : t
          ? (this.domainId = t)
          : l.stubScriptElement ||
            ((l.stubScriptElement = document.querySelector(
            ...
            l.stubScriptElement &&
              ((l.isMigratedURL = !0), (this.domainId = l.migratedDomainId.trim())));
    }),
    (f.prototype.setDomainDataFileURL = function () {
      ...
      t &&
        (l.isMigratedURL
          ...
          : (l.storageBaseURL = (
              e ? t.split('/consent') : t.split('/scripttemplates/' + l.stubFileName)
            )[0])),
    ...
    (this.iabType = null),
        ...
        var e = s.getRegionSet(t),
          ...
          n = t.UseSDKRefactor
            ...
            : '5.11.0' === t.Version
              ...
              : (l.isMigratedURL &&
                  (i.src =
                    l.storageBaseURL + '/scripttemplates/' + l.stubFileName + '.js'),
                l.storageBaseURL +
                  '/scripttemplates/' +
                  t.Version +
                  '/' +
      ...
      (this.addIabFrame = function () {
        var t = window,
          e = '__tcfapiLocator';
        !t.frames[e] &&
          (t.document.body ? s.addLocator(e, 'CMP') : setTimeout(s.addIabFrame, 5));
      }),
      (this.addBackwardIabFrame = function () {
        var t = window,
          e = '__tcfapiLocator';
        !t.frames[e] &&
          (t.document.body ? s.addLocator(e, 'TCF') : setTimeout(s.addIabFrame, 5));
      }),
        ...
        e.__cmpCall &&
          ...
          e.__tcfapiCall &&
            ...
            s.executeTcfApi(
              ...
              function (t, e) {
                t = {
                  __tcfapiReturn: { returnValue: t, success: e, callId: n, command: a },
                };
                i &&
                  i.source &&
                  i.source.postMessage &&
